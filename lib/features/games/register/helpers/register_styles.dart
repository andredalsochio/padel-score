...
class RegisterStyles {
  ...
  static BorderRadius get cardRadius => const BorderRadius.all(Radius.circular(16));
  ...
  static EdgeInsets get sectionPadding => const EdgeInsets.symmetric(horizontal: 16, vertical: 12);
  static EdgeInsets get cardPadding => const EdgeInsets.all(12);

  static Color surfaceHigh(ColorScheme scheme) => scheme.surfaceContainerHighest;
